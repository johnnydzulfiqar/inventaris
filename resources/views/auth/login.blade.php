...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('layout/assets/img/favicon/favicon.ico') }}" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('layout/assets/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
